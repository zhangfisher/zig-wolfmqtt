...
#ifdef WOLFMQTT_V5
    word16      alias;
    byte        retain_handling; /* Bits 4-5: 0=Send retained, 1=Send without retain, 2=Don't send */
    byte        no_local;        /* Bit 2: 1=Don't receive own messages, 0=Receive all */
    byte        rap;              /* Bit 3: Retain As Published - keep original retain flag */
#endif
} MqttTopic;
